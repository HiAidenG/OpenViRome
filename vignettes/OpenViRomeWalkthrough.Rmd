...
We can also just calculate diversity metrics individually for each biosample:
```{r}
# Shannon diversity
getAlphaDiversity(TylenchoideaVirome, mode = "shannon", bioSample=c("SAMN08001176"))

# Simpson diversity
getAlphaDiversity(TylenchoideaVirome, mode = "simpson", bioSample=c("SAMN08001176"))

# Also supports 'evenness' and 'richness' with the mode argument

# Or for the whole virome
